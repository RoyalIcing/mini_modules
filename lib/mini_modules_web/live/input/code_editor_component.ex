defmodule MiniModulesWeb.Input.CodeEditorComponent do
  ...
  def monaco(assigns) do
    ~H"""
    <minimodules-monaco-editor id={@id} change-clock={@change_clock} source={@input} style="display: block; width: 900px; height: 400px;" phx-hook="WebComponent" name={@name} phx-update="ignore">
