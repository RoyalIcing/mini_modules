defmodule MiniModulesWeb.UniversalModulesController do
  ...
  alias MiniModulesWeb.UniversalModulesParser, as: Parser
...
defmodule MiniModulesWeb.UniversalModulesParser do
  ...
  defmodule Root do
    defdelegate compose(submodule, input), to: MiniModulesWeb.UniversalModulesParser
  ...
  defmodule Export do
    def decode(<<"export ", rest::bitstring>>) do
      case MiniModulesWeb.UniversalModulesParser.compose(Const, rest) do
        {:ok, term, rest} ->
          {:ok, {:export, term}, rest}
  ...
  defmodule Yield do
    def decode(<<"yield ", rest::bitstring>>) do
      case MiniModulesWeb.UniversalModulesParser.compose(Expression, rest) do
        {:ok, term, rest} ->
          {:ok, {:yield, term}, rest}
  ...
  defmodule Const do
    ...
    defp decode({identifier, :expect_expression, []}, input) do
      case MiniModulesWeb.UniversalModulesParser.compose(Expression, input) do
        {:ok, expression, rest} ->
